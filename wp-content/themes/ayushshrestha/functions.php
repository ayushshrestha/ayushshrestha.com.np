...
if ( ! function_exists( 'ayushshrestha_setup' ) ) :
	/**
	...
	function ayushshrestha_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'ayushshrestha' ),
			)
		);
...
function ayushshrestha_scripts() {
	...
	wp_enqueue_style( 'ayushshrestha-css', get_template_directory_uri() . '/assets/css/style.min.css', array(), _S_VERSION);
	wp_enqueue_script( 'ayushshrestha-jquery-slim', get_template_directory_uri() . '/assets/js/jquery-slim.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'ayushshrestha-js-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.bundle.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'ayushshrestha-js', get_template_directory_uri() . '/assets/js/custom.js', array(), _S_VERSION, true );
...
function portfolios(){
	$args = [
		...
		'supports' => ['title', 'editor', 'thumbnail', 'tag']
	];
