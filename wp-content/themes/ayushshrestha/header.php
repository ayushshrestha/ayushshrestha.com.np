...
<body <?php body_class("bg-slate-100 dark:bg-black dark:text-white/50"); ?>>
<?php wp_body_open(); ?>
			...
			<div class="flex">
				<div class="w-7">
					...
					if ( $ayushshrestha_description || is_customize_preview() ) :
						?>
						<p class="site-description sr-only"><?php echo $ayushshrestha_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
					<?php endif; ?>
				</div><!-- .site-branding -->
			</div>
			<div class="flex">
